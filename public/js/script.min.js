...
"html"===value&&(value="xml"),editorArray.blockCode.setOption("mode",value),$("#blockCode").attr("data-lang",value)}),"undefined"!=typeof editorArray.blockCode&&editorArray.blockCode.on("blur",function(){$("#blockCode").val(editorArray.blockCode.getValue()),$("#blockCode").trigger("blur")}),$(".menu-button a:first-of-type, .close-button").on("click",function(event){event.preventDefault(),$("body").toggleClass("show-menu")});var mentionarea=$(".mentionarea");mentionarea.length>0&&$.get("/api/user",function(data){mentionarea.mention({delimiter:"@",queryBy:["username"],users:data.data})}),$("#browseTabs ul:first-of-type li a").click(function(event){event.preventDefault(),$("#browseTabs ul li").removeClass("open"),$(this).parent().addClass("open"),$($("#browseTabs ul:last-of-type li").get($(this).parent().index())).addClass("open")})});