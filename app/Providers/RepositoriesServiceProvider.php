...
class RepositoriesServiceProvider extends ServiceProvider
{
	...
	public function register()
	{
		...
		$this->app->bind('App\Repositories\Comment\CommentRepository',
			'App\Repositories\Comment\EloquentCommentRepository');
		$this->app->bind('App\Repositories\Permission\PermissionRepository',
		...
		$this->app->bind('App\Repositories\Notification\NotificationRepository',
			'App\Repositories\Notification\EloquentNotificationRepository');
		...
		$this->app->bind('App\Repositories\Article\ArticleRepository',
		...
		$this->app->bind('App\Repositories\TeamInvite\TeamInviteRepository',
			'App\Repositories\TeamInvite\EloquentTeamInviteRepository');
		$this->app->bind('App\Repositories\Team\TeamRepository', 'App\Repositories\Team\EloquentTeamRepository');
		$this->app->bind('App\Repositories\Message\MessageRepository',
